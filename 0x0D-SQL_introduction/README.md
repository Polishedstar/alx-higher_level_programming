...
This was my first SQL project At Alx Software Engineering Course in which I began to work with SQL and relational databases.This project was mainly about  data definition, data manipulation language, making subqueries, and using functions.
